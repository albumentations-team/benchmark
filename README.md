...
- Micro benchmarks measure only the named transform in each library's native layout. Do not add `Normalize`, `ToTensor`, axis conversion, or DataLoader collation work to micro specs.
